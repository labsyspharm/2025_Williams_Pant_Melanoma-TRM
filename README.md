...
--------------------
​
1. **Publication or Dataset title:** The initial melanoma T cell infiltrate is defined by tissue-resident programs restrained by regulatory T cells 
​
2. **Authors:** Jason B. Williams*, Shishir M. Pant2,*, Alexander L. Kley, Bharat A. Rajmalani, Clarence Yapp, Jiang
Zhang1, Kyle Deans, Elizabeth Rotrosen, Angelika Sales Peter K. Soger and Thomas S. Kupper†
* These (co-first) authors contributed equally
†Corresponding Author; tkupper@bwh.harvard.edu
​
4. **Please cite this data as the following:**  <Following standard APA citation format - if this data is associated with a publication, this should be the paper citation>    
...
> * Associated GitHub Repository: [MY-REPO](https://github.com/labsyspharm/2025_Williams_Pant_Melanoma-TRM)  
